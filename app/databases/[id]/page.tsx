...
import { ArrowLeft, Database, Edit, Trash2, RefreshCw, AlertCircle, Table, CheckCircle, XCircle, Clock, Settings } from 'lucide-react';
...
export default function DatabaseDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <Header showPageTitle={true} pageTitle="数据源详情" />
